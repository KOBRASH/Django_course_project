    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_email', models.ManyToManyField(to='mailer.client', verbose_name='контактный email')),
                ('mail_title', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='mailer.message', verbose_name='тема рассылки')),
            ],
            options={
